...
/***/ "D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\scss\\pages\\essays-manage.scss":
/*!********************************************************************************************!*\
  !*** D:\coding\repos\BlogZ\BlogZ\wwwroot\assets\BackCms\src\scss\pages\essays-manage.scss ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\ts\\pages\\essays-manage.ts":
/*!****************************************************************************************!*\
  !*** D:\coding\repos\BlogZ\BlogZ\wwwroot\assets\BackCms\src\ts\pages\essays-manage.ts ***!
  \****************************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
__webpack_require__(/*! ../../scss/pages/essays-manage.scss */ "D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\scss\\pages\\essays-manage.scss");
(function () {
    var changeStatus = "/api/Essays/ChangeStatus";
    ...
    var eventManager = function (action, idArr) {
        ...
        switch (action.toLocaleLowerCase()) {
            case "del":
                Global_1.default.confirm("确认删除吗?", function () {
                    Global_1.default.showLoading();
                    var result = dataTable_1.default.defautlDelete(dt, "/api/Essays/Delete", idArr, function (msg) {
                        if (msg.Code === 0 && msg.Data) {
                            Global_1.default.alert("删除成功!");
                            dt.reload();
                        }
    ...
    var bindEvent = function () {
        ...
        $(".edit").click(function () {
            var selectIdArr = dt.selectIdArr;
            if (selectIdArr.length !== 1) {
                return Global_1.default.alert("请仅选择一项");
            }
            //else
            location.href = "/BackCms/Essays/Edit?Id=" + selectIdArr[0];
        });
        $(".del").click(function () {
            eventManager("del");
        });
    ...
    var dtZConfig = {
        ...
        columns: [
            dataTable_1.default.checkBoxCol(),
            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    var html = "<a href=\"/Essays/Details/" + row["Slug"] + "\" target=\"_blank\">" + data + "</a> <span class=\"badge " + color + " status\" data-status=\"" + status + "\" data-id=\"" + row["Id"] + "\">" + DefaultStatus_1.getStatusText(status) + "</span>";
                    return html;
                }
            },
            {
            ...
            {
                "data": "EssayType", "title": "分类", width: "58px"
            },
            {
                "data": "Tags", "title": "标签",
                render: function (data, type, row, meta) {
            ...
            {
                "data": "ReadNum", "title": "阅读量"
            },
            {
                "data": "Praise", "title": "Praise"
            },
            {
                "data": "Criticize", "title": "Criticize"
            },
            {
                "data": "Id", "title": "操作",
                render: function (data, type, row, meta) {
        ...
        ajaxUrl: "/api/Essays/Table",
        moreDataFields: ['Status', 'Slug'],
        initComplete: function () {
            bindEvent();
        },
        afterDraw: function (setting) {
...
/******/ 	var __webpack_exports__ = __webpack_require__("D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\ts\\pages\\essays-manage.ts");
/******/ 	
/******/ })()
;
//# sourceMappingURL=essays-manage.bundle.js.map