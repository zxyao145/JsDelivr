...
/***/ "D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\ts\\pages\\essays-comments.ts":
/*!******************************************************************************************!*\
  !*** D:\coding\repos\BlogZ\BlogZ\wwwroot\assets\BackCms\src\ts\pages\essays-comments.ts ***!
  \******************************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
(function () {
    ...
    var subCommentReplyApi = "/api/EssayComment/ReplyUser";
    var softDeleteApi = "/api/EssayComment/Delete";
    var readApi = "/api/EssayComment/Read";
    var replyApi = "/api/EssayComment/Replied";
    var toPublucApi = "/api/EssayComment/ToPublic";
    var toSecretApi = "/api/EssayComment/ToSecret";
    var essayInfoApi = "/api/EssayComment/EssayInfo";
    //所有文章列表请求
    $.ajax({
        url: essayInfoApi,
        type: "get",
        success: function (msg) {
            if (msg.Code === 0) {
                ...
                $("#essayTitle").html(optionsHtml).selectpicker('refresh');
            }
        }
    });
    ...
    var bindDrawCallBackEvent = function () {
        console.log("bindDrawCallBackEvent");
    ...
    var dtZConfig = {
        ...
        columns: [
            ...
            //{
            //    "data": "UaMeta_BrowserName", "title": "浏览器"
            //},
            //{
            //    "data": "UaMeta_OsName", "title": "操作系统"
            //},
            {
                "data": "Id", "title": "操作",
                render: function (data, type, row, meta) {
                    return "<div class=\"btn-group \">\n                    <button class=\"btn btn-info btn-sm text-white see-comment\">\u67E5\u770B</button>\n                    <button class=\"btn btn-secondary btn-sm text-white row-reply\">\u56DE\u590D</button>\n                    <button class=\"btn btn-danger btn-sm row-del\" data-id=\"" + data + "\">\u5220\u9664</button>                    \n                </div>";
                }
            }
        ],
        ajaxUrl: "/api/EssayComment/Table",
    ...
    $("#submitReply").click(function () {
        ...
        obj.content = content;
        obj.essayId = $('#replyModal').data("essayId");
        Global_1.default.showLoading();
        $.ajax({
...
/******/ 	var __webpack_exports__ = __webpack_require__("D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\ts\\pages\\essays-comments.ts");
/******/ 	
/******/ })()
;
//# sourceMappingURL=essays-comments.bundle.js.map