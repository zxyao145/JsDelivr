...
/***/ "D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\ts\\pages\\trivial-edit.ts":
/*!***************************************************************************************!*\
  !*** D:\coding\repos\BlogZ\BlogZ\wwwroot\assets\BackCms\src\ts\pages\trivial-edit.ts ***!
  \***************************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
$(function () {
    var editApi = "/api/Trivial/Edit";
    var postCallBackUrl = "/BackCms/Trivial/Index";
    var createDtPicker;
    var modifyDtPicker;
    /**
     * 初始化DtPicker
    ...
    var initUi = function (data) {
        ...
        if (data.Status === DefaultStatus_1.DefaultStatus.Secret) {
            $("#secret").attr('checked', 'checked');
        }
        TinyMceHelper_1.default.setContent(data.Content, "tinyEditor");
    };
    /**
     * 请求文章
     * @param essayId 请求文章的id
     */
    ...
    TinyMceHelper_1.default.init("#tinyEditor", 'full', "380", "100%", {
        toolbar_mode: 'wrap'
    });
    //判断是否为编辑模式
    if (editInfo.isEdit) {
    ...
    var handlerSubmit = function () {
        var submit = function (data) {
            data.content = TinyMceHelper_1.default.getContent("tinyEditor");
            if (data.sticky) {
                data.sticky = true;
            }
            else {
        ...
        $("#publish").click(function (e) {
            ...
            if ($("#secret").is(":checked")) {
                forDataObj.status = DefaultStatus_1.DefaultStatus.Secret;
            }
            else {
                forDataObj.status = DefaultStatus_1.DefaultStatus.Published;
            }
            submit(forDataObj);
        });
        $("#draft").click(function (e) {
            ...
            if ($("#secret").is(":checked")) {
                ...
                forDataObj.status = DefaultStatus_1.DefaultStatus.Draft;
            }
            submit(forDataObj);
        });
    };
...
/******/ 	var __webpack_exports__ = __webpack_require__("D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\ts\\pages\\trivial-edit.ts");
/******/ 	
/******/ })()
;
//# sourceMappingURL=trivial-edit.bundle.js.map