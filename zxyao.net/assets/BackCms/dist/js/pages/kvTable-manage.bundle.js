...
/***/ "D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\scss\\pages\\kvTable-manage.scss":
/*!*********************************************************************************************!*\
  !*** D:\coding\repos\BlogZ\BlogZ\wwwroot\assets\BackCms\src\scss\pages\kvTable-manage.scss ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\ts\\pages\\kvTable-manage.ts":
/*!*****************************************************************************************!*\
  !*** D:\coding\repos\BlogZ\BlogZ\wwwroot\assets\BackCms\src\ts\pages\kvTable-manage.ts ***!
  \*****************************************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
__webpack_require__(/*! ../../scss/pages/kvTable-manage.scss */ "D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\scss\\pages\\kvTable-manage.scss");
(function () {
    var tableApi = "/api/KvTable/Table";
    var softDelApi = "/api/KvTable/Delete";
    var changeStatus = "/api/KvTable/ChangeStatus";
    var editView = "/BackCms/KvTable/Edit";
    ...
    var eventManager = function (action, idArr) {
        ...
        switch (action.toLocaleLowerCase()) {
            case "del":
                ...
                var result = dataTable_1.default.defautlDelete(dt, softDelApi, idArr, function (msg) {
                    dt.reload();
            ...
            case "see":
                if (tableRenderData) {
                    var id = idArr[0];
                    var key = void 0, value = "";
                    for (var _i = 0, tableRenderData_1 = tableRenderData; _i < tableRenderData_1.length; _i++) {
                        var row = tableRenderData_1[_i];
                        if (row.Id === id) {
                            key = row.Key;
                            value = row.Value;
                            break;
                    ...
                    if (key) {
                        $("#dataModal .modal-title").html('Key: ' + key);
                        $("#dataModal .modal-body").html(value);
    ...
    var bindDrawCallBackEvent = function () {
        ...
        $("tbody .row-see").on("click", function (e) {
            e.preventDefault();
            var id = $(e.target).data("id");
            eventManager("see", [id]);
        });
        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    var html = "<span class=\"badge " + color + " status\" data-status=\"" + status + "\" data-id=\"" + row["Id"] + "\">" + DefaultStatus_1.getStatusText(status) + "</span>";
                    return html;
                }
            },
            {
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    return "<div class=\"row-content\">" + data + "</div>";
                },
            },
            {
                "data": "Id", "title": "操作",
                render: function (data, type, row, meta) {
                    return "<div class=\"btn-group \">\n                    <button class=\"btn btn-primary btn-sm row-see\" data-id=\"" + data + "\">\u67E5\u770B</button>                    \n                    <a class=\"btn btn-secondary btn-sm\" href=\"" + editView + "?Id=" + data + "\">\u4FEE\u6539</a>\n                    <button class=\"btn btn-danger btn-sm row-del\" data-id=\"" + data + "\">\u5220\u9664</button>\n                    </div>";
                }
            }
        ],
        ajaxUrl: tableApi,
...
/******/ 	var __webpack_exports__ = __webpack_require__("D:\\coding\\repos\\BlogZ\\BlogZ\\wwwroot\\assets\\BackCms\\src\\ts\\pages\\kvTable-manage.ts");
/******/ 	
/******/ })()
;
//# sourceMappingURL=kvTable-manage.bundle.js.map